...
class TestParcelInvoiceApi(unittest.TestCase):
    ...
    def test_add_parcel_invoice_file_by_url(self):
        """Test case for add_parcel_invoice_file_by_url
    ...
    def test_delete_parcel_invoice_file(self):
        """Test case for delete_parcel_invoice_file
    ...
    def test_get_parcel_invoice_files(self):
        """Test case for get_parcel_invoice_files
