...
class ReceivingWorksheetApi(object):
    ...
    def add_receiving_worksheet_file(self, receiving_worksheet_id, file_name, **kwargs):  # noqa: E501
    ...
    def add_receiving_worksheet_file_with_http_info(self, receiving_worksheet_id, file_name, **kwargs):  # noqa: E501
        """Attach a file to a receivingWorksheet  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_receiving_worksheet_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'receiving_worksheet_id' is set
        if ('receiving_worksheet_id' not in params or
                params['receiving_worksheet_id'] is None):
            raise ValueError("Missing the required parameter `receiving_worksheet_id` when calling `add_receiving_worksheet_file`")  # noqa: E501
        # verify the required parameter 'file_name' is set
        if ('file_name' not in params or
                params['file_name'] is None):
            raise ValueError("Missing the required parameter `file_name` when calling `add_receiving_worksheet_file`")  # noqa: E501
    ...
    def add_receiving_worksheet_file_by_url(self, body, receiving_worksheet_id, **kwargs):  # noqa: E501
    ...
    def add_receiving_worksheet_file_by_url_with_http_info(self, body, receiving_worksheet_id, **kwargs):  # noqa: E501
        """Attach a file to a receivingWorksheet by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_receiving_worksheet_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_receiving_worksheet_file_by_url`")  # noqa: E501
        # verify the required parameter 'receiving_worksheet_id' is set
        if ('receiving_worksheet_id' not in params or
                params['receiving_worksheet_id'] is None):
            raise ValueError("Missing the required parameter `receiving_worksheet_id` when calling `add_receiving_worksheet_file_by_url`")  # noqa: E501
    ...
    def delete_receiving_worksheet_file(self, receiving_worksheet_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_receiving_worksheet_file_with_http_info(self, receiving_worksheet_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a receivingWorksheet.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_receiving_worksheet_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'receiving_worksheet_id' is set
        if ('receiving_worksheet_id' not in params or
                params['receiving_worksheet_id'] is None):
            raise ValueError("Missing the required parameter `receiving_worksheet_id` when calling `delete_receiving_worksheet_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_receiving_worksheet_file`")  # noqa: E501
    ...
    def get_receiving_worksheet_files(self, receiving_worksheet_id, **kwargs):  # noqa: E501
    ...
    def get_receiving_worksheet_files_with_http_info(self, receiving_worksheet_id, **kwargs):  # noqa: E501
        """Get the files for a receivingWorksheet.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_receiving_worksheet_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'receiving_worksheet_id' is set
        if ('receiving_worksheet_id' not in params or
                params['receiving_worksheet_id'] is None):
            raise ValueError("Missing the required parameter `receiving_worksheet_id` when calling `get_receiving_worksheet_files`")  # noqa: E501
