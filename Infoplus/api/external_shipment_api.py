...
class ExternalShipmentApi(object):
    ...
    def execute_external_shipment(self, body, **kwargs):  # noqa: E501
        """Run the ExecuteExternalShipment process.  # noqa: E501
        ...
        :param async bool
        :param ExecuteExternalShipmentInputAPIModel body: Input data for ExecuteExternalShipment process. (required)
