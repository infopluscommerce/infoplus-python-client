...
class ExternalShipmentApi(object):
    ...
    def add_external_shipment_file_by_url(self, body, external_shipment_id, **kwargs):  # noqa: E501
    ...
    def add_external_shipment_file_by_url_with_http_info(self, body, external_shipment_id, **kwargs):  # noqa: E501
        """Attach a file to an externalShipment by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_external_shipment_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_external_shipment_file_by_url`")  # noqa: E501
        # verify the required parameter 'external_shipment_id' is set
        if ('external_shipment_id' not in params or
                params['external_shipment_id'] is None):
            raise ValueError("Missing the required parameter `external_shipment_id` when calling `add_external_shipment_file_by_url`")  # noqa: E501
    ...
    def delete_external_shipment_file(self, external_shipment_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_external_shipment_file_with_http_info(self, external_shipment_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for an externalShipment.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_external_shipment_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'external_shipment_id' is set
        if ('external_shipment_id' not in params or
                params['external_shipment_id'] is None):
            raise ValueError("Missing the required parameter `external_shipment_id` when calling `delete_external_shipment_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_external_shipment_file`")  # noqa: E501
    ...
    def execute_external_shipment(self, body, **kwargs):  # noqa: E501
        """Execute externalShipment  # noqa: E501

        Execute externalShipments using the specified id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.execute_external_shipment(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param ExecuteExternalShipmentInputAPIModel body: ExternalShipment to be executed. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.execute_external_shipment_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.execute_external_shipment_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def execute_external_shipment_with_http_info(self, body, **kwargs):  # noqa: E501
        """Execute externalShipment  # noqa: E501

        Execute externalShipments using the specified id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.execute_external_shipment_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method execute_external_shipment" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `execute_external_shipment`")  # noqa: E501
    ...
    def get_external_shipment_files(self, external_shipment_id, **kwargs):  # noqa: E501
    ...
    def get_external_shipment_files_with_http_info(self, external_shipment_id, **kwargs):  # noqa: E501
        """Get the files for an externalShipment.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_external_shipment_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'external_shipment_id' is set
        if ('external_shipment_id' not in params or
                params['external_shipment_id'] is None):
            raise ValueError("Missing the required parameter `external_shipment_id` when calling `get_external_shipment_files`")  # noqa: E501
