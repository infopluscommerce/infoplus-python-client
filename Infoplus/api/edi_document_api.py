...
class EdiDocumentApi(object):
    ...
    def add_edi_document_file_by_url(self, body, edi_document_id, **kwargs):  # noqa: E501
        """Attach a file to an ediDocument by URL.  # noqa: E501
    ...
    def add_edi_document_file_by_url_with_http_info(self, body, edi_document_id, **kwargs):  # noqa: E501
        """Attach a file to an ediDocument by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_edi_document_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_edi_document_file_by_url`")  # noqa: E501
        # verify the required parameter 'edi_document_id' is set
        if ('edi_document_id' not in params or
                params['edi_document_id'] is None):
            raise ValueError("Missing the required parameter `edi_document_id` when calling `add_edi_document_file_by_url`")  # noqa: E501
    ...
    def delete_edi_document_file(self, edi_document_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for an ediDocument.  # noqa: E501
    ...
    def delete_edi_document_file_with_http_info(self, edi_document_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for an ediDocument.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_edi_document_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'edi_document_id' is set
        if ('edi_document_id' not in params or
                params['edi_document_id'] is None):
            raise ValueError("Missing the required parameter `edi_document_id` when calling `delete_edi_document_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_edi_document_file`")  # noqa: E501
    ...
    def get_edi_document_files(self, edi_document_id, **kwargs):  # noqa: E501
        """Get the files for an ediDocument.  # noqa: E501
    ...
    def get_edi_document_files_with_http_info(self, edi_document_id, **kwargs):  # noqa: E501
        """Get the files for an ediDocument.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_edi_document_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'edi_document_id' is set
        if ('edi_document_id' not in params or
                params['edi_document_id'] is None):
            raise ValueError("Missing the required parameter `edi_document_id` when calling `get_edi_document_files`")  # noqa: E501
