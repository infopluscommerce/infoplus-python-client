...
class AlertApi(object):
    ...
    def add_alert_file_by_url(self, body, alert_id, **kwargs):  # noqa: E501
    ...
    def add_alert_file_by_url_with_http_info(self, body, alert_id, **kwargs):  # noqa: E501
        """Attach a file to an alert by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_alert_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_alert_file_by_url`")  # noqa: E501
        # verify the required parameter 'alert_id' is set
        if ('alert_id' not in params or
                params['alert_id'] is None):
            raise ValueError("Missing the required parameter `alert_id` when calling `add_alert_file_by_url`")  # noqa: E501
    ...
    def delete_alert_file(self, alert_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_alert_file_with_http_info(self, alert_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for an alert.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_alert_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'alert_id' is set
        if ('alert_id' not in params or
                params['alert_id'] is None):
            raise ValueError("Missing the required parameter `alert_id` when calling `delete_alert_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_alert_file`")  # noqa: E501
    ...
    def get_alert_files(self, alert_id, **kwargs):  # noqa: E501
    ...
    def get_alert_files_with_http_info(self, alert_id, **kwargs):  # noqa: E501
        """Get the files for an alert.  # noqa: E501
        ...
        if ('alert_id' not in params or
                params['alert_id'] is None):
            raise ValueError("Missing the required parameter `alert_id` when calling `get_alert_files`")  # noqa: E501
