...
class OrderInvoiceTemplateLineItemDescriptionEnumApi(object):
    ...
    def get_order_invoice_template_line_item_description_enum_by_id(self, order_invoice_template_line_item_description_enum_id, **kwargs):  # noqa: E501
    ...
    def get_order_invoice_template_line_item_description_enum_by_id_with_http_info(self, order_invoice_template_line_item_description_enum_id, **kwargs):  # noqa: E501
        """Get an orderInvoiceTemplateLineItemDescriptionEnum by id  # noqa: E501
        ...
        if ('order_invoice_template_line_item_description_enum_id' not in params or
                params['order_invoice_template_line_item_description_enum_id'] is None):
            raise ValueError("Missing the required parameter `order_invoice_template_line_item_description_enum_id` when calling `get_order_invoice_template_line_item_description_enum_by_id`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'order_invoice_template_line_item_description_enum_id' in params:
            path_params['orderInvoiceTemplateLineItemDescriptionEnumId'] = params['order_invoice_template_line_item_description_enum_id']  # noqa: E501
    ...
    def get_order_invoice_template_line_item_description_enum_by_search_text(self, **kwargs):  # noqa: E501
    ...
    def get_order_invoice_template_line_item_description_enum_by_search_text_with_http_info(self, **kwargs):  # noqa: E501
        """Search orderInvoiceTemplateLineItemDescriptionEnums  # noqa: E501
