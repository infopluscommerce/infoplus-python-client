...
class ProductionModelApi(object):
    ...
    def add_production_model_file_by_url(self, body, production_model_id, **kwargs):  # noqa: E501
    ...
    def add_production_model_file_by_url_with_http_info(self, body, production_model_id, **kwargs):  # noqa: E501
        """Attach a file to a productionModel by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_production_model_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_production_model_file_by_url`")  # noqa: E501
        # verify the required parameter 'production_model_id' is set
        if ('production_model_id' not in params or
                params['production_model_id'] is None):
            raise ValueError("Missing the required parameter `production_model_id` when calling `add_production_model_file_by_url`")  # noqa: E501
    ...
    def delete_production_model_file(self, production_model_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_production_model_file_with_http_info(self, production_model_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a productionModel.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_production_model_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'production_model_id' is set
        if ('production_model_id' not in params or
                params['production_model_id'] is None):
            raise ValueError("Missing the required parameter `production_model_id` when calling `delete_production_model_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_production_model_file`")  # noqa: E501
    ...
    def get_production_model_files(self, production_model_id, **kwargs):  # noqa: E501
    ...
    def get_production_model_files_with_http_info(self, production_model_id, **kwargs):  # noqa: E501
        """Get the files for a productionModel.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_production_model_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'production_model_id' is set
        if ('production_model_id' not in params or
                params['production_model_id'] is None):
            raise ValueError("Missing the required parameter `production_model_id` when calling `get_production_model_files`")  # noqa: E501
