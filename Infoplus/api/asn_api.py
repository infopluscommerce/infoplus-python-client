...
class AsnApi(object):
    ...
    def close_asn(self, body, **kwargs):  # noqa: E501
        """Run the ClosePurchProcess process.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.close_asn(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param ClosePurchProcessInputAPIModel body: Input data for ClosePurchProcess process. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.close_asn_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.close_asn_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def close_asn_with_http_info(self, body, **kwargs):  # noqa: E501
        """Run the ClosePurchProcess process.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.close_asn_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `close_asn`")  # noqa: E501
