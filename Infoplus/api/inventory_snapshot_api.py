...
class InventorySnapshotApi(object):
    ...
    def add_inventory_snapshot_file_by_url(self, body, inventory_snapshot_id, **kwargs):  # noqa: E501
    ...
    def add_inventory_snapshot_file_by_url_with_http_info(self, body, inventory_snapshot_id, **kwargs):  # noqa: E501
        """Attach a file to an inventorySnapshot by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_inventory_snapshot_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_inventory_snapshot_file_by_url`")  # noqa: E501
        # verify the required parameter 'inventory_snapshot_id' is set
        if ('inventory_snapshot_id' not in params or
                params['inventory_snapshot_id'] is None):
            raise ValueError("Missing the required parameter `inventory_snapshot_id` when calling `add_inventory_snapshot_file_by_url`")  # noqa: E501
    ...
    def delete_inventory_snapshot_file(self, inventory_snapshot_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_inventory_snapshot_file_with_http_info(self, inventory_snapshot_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for an inventorySnapshot.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_inventory_snapshot_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'inventory_snapshot_id' is set
        if ('inventory_snapshot_id' not in params or
                params['inventory_snapshot_id'] is None):
            raise ValueError("Missing the required parameter `inventory_snapshot_id` when calling `delete_inventory_snapshot_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_inventory_snapshot_file`")  # noqa: E501
    ...
    def get_inventory_snapshot_files(self, inventory_snapshot_id, **kwargs):  # noqa: E501
    ...
    def get_inventory_snapshot_files_with_http_info(self, inventory_snapshot_id, **kwargs):  # noqa: E501
        """Get the files for an inventorySnapshot.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_inventory_snapshot_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'inventory_snapshot_id' is set
        if ('inventory_snapshot_id' not in params or
                params['inventory_snapshot_id'] is None):
            raise ValueError("Missing the required parameter `inventory_snapshot_id` when calling `get_inventory_snapshot_files`")  # noqa: E501
