...
class StandardBusinessDaysApi(object):
    ...
    def add_standard_business_days_file_by_url(self, body, standard_business_days_id, **kwargs):  # noqa: E501
    ...
    def add_standard_business_days_file_by_url_with_http_info(self, body, standard_business_days_id, **kwargs):  # noqa: E501
        """Attach a file to a standardBusinessDays by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_standard_business_days_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_standard_business_days_file_by_url`")  # noqa: E501
        # verify the required parameter 'standard_business_days_id' is set
        if ('standard_business_days_id' not in params or
                params['standard_business_days_id'] is None):
            raise ValueError("Missing the required parameter `standard_business_days_id` when calling `add_standard_business_days_file_by_url`")  # noqa: E501
    ...
    def delete_standard_business_days_file(self, standard_business_days_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_standard_business_days_file_with_http_info(self, standard_business_days_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a standardBusinessDays.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_standard_business_days_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'standard_business_days_id' is set
        if ('standard_business_days_id' not in params or
                params['standard_business_days_id'] is None):
            raise ValueError("Missing the required parameter `standard_business_days_id` when calling `delete_standard_business_days_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_standard_business_days_file`")  # noqa: E501
    ...
    def get_standard_business_days_files(self, standard_business_days_id, **kwargs):  # noqa: E501
    ...
    def get_standard_business_days_files_with_http_info(self, standard_business_days_id, **kwargs):  # noqa: E501
        """Get the files for a standardBusinessDays.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_standard_business_days_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'standard_business_days_id' is set
        if ('standard_business_days_id' not in params or
                params['standard_business_days_id'] is None):
            raise ValueError("Missing the required parameter `standard_business_days_id` when calling `get_standard_business_days_files`")  # noqa: E501
