...
class FulfillmentLayoutPositionApi(object):
    ...
    def add_fulfillment_layout_position_audit(self, fulfillment_layout_position_id, fulfillment_layout_position_audit, **kwargs):  # noqa: E501
    ...
    def add_fulfillment_layout_position_audit_with_http_info(self, fulfillment_layout_position_id, fulfillment_layout_position_audit, **kwargs):  # noqa: E501
        """Add new audit for a fulfillmentLayoutPosition  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method add_fulfillment_layout_position_audit" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `add_fulfillment_layout_position_audit`")  # noqa: E501
        # verify the required parameter 'fulfillment_layout_position_audit' is set
        if ('fulfillment_layout_position_audit' not in params or
                params['fulfillment_layout_position_audit'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_audit` when calling `add_fulfillment_layout_position_audit`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'fulfillment_layout_position_id' in params:
            path_params['fulfillmentLayoutPositionId'] = params['fulfillment_layout_position_id']  # noqa: E501
        if 'fulfillment_layout_position_audit' in params:
            path_params['fulfillmentLayoutPositionAudit'] = params['fulfillment_layout_position_audit']  # noqa: E501
    ...
    def add_fulfillment_layout_position_file(self, fulfillment_layout_position_id, file_name, **kwargs):  # noqa: E501
    ...
    def add_fulfillment_layout_position_file_with_http_info(self, fulfillment_layout_position_id, file_name, **kwargs):  # noqa: E501
        """Attach a file to a fulfillmentLayoutPosition  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_fulfillment_layout_position_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `add_fulfillment_layout_position_file`")  # noqa: E501
        # verify the required parameter 'file_name' is set
        if ('file_name' not in params or
                params['file_name'] is None):
            raise ValueError("Missing the required parameter `file_name` when calling `add_fulfillment_layout_position_file`")  # noqa: E501
    ...
    def add_fulfillment_layout_position_file_by_url(self, body, fulfillment_layout_position_id, **kwargs):  # noqa: E501
    ...
    def add_fulfillment_layout_position_file_by_url_with_http_info(self, body, fulfillment_layout_position_id, **kwargs):  # noqa: E501
        """Attach a file to a fulfillmentLayoutPosition by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_fulfillment_layout_position_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_fulfillment_layout_position_file_by_url`")  # noqa: E501
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `add_fulfillment_layout_position_file_by_url`")  # noqa: E501
    ...
    def add_fulfillment_layout_position_tag(self, fulfillment_layout_position_id, fulfillment_layout_position_tag, **kwargs):  # noqa: E501
    ...
    def add_fulfillment_layout_position_tag_with_http_info(self, fulfillment_layout_position_id, fulfillment_layout_position_tag, **kwargs):  # noqa: E501
        """Add new tags for a fulfillmentLayoutPosition.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_fulfillment_layout_position_tag" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `add_fulfillment_layout_position_tag`")  # noqa: E501
        # verify the required parameter 'fulfillment_layout_position_tag' is set
        if ('fulfillment_layout_position_tag' not in params or
                params['fulfillment_layout_position_tag'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_tag` when calling `add_fulfillment_layout_position_tag`")  # noqa: E501
        ...
        if 'fulfillment_layout_position_id' in params:
            path_params['fulfillmentLayoutPositionId'] = params['fulfillment_layout_position_id']  # noqa: E501
        if 'fulfillment_layout_position_tag' in params:
            path_params['fulfillmentLayoutPositionTag'] = params['fulfillment_layout_position_tag']  # noqa: E501
    ...
    def delete_fulfillment_layout_position_file(self, fulfillment_layout_position_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_fulfillment_layout_position_file_with_http_info(self, fulfillment_layout_position_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a fulfillmentLayoutPosition.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_fulfillment_layout_position_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `delete_fulfillment_layout_position_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_fulfillment_layout_position_file`")  # noqa: E501
    ...
    def delete_fulfillment_layout_position_tag(self, fulfillment_layout_position_id, fulfillment_layout_position_tag, **kwargs):  # noqa: E501
    ...
    def delete_fulfillment_layout_position_tag_with_http_info(self, fulfillment_layout_position_id, fulfillment_layout_position_tag, **kwargs):  # noqa: E501
        """Delete a tag for a fulfillmentLayoutPosition.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_fulfillment_layout_position_tag" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `delete_fulfillment_layout_position_tag`")  # noqa: E501
        # verify the required parameter 'fulfillment_layout_position_tag' is set
        if ('fulfillment_layout_position_tag' not in params or
                params['fulfillment_layout_position_tag'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_tag` when calling `delete_fulfillment_layout_position_tag`")  # noqa: E501
    ...
    def get_duplicate_fulfillment_layout_position_by_id(self, fulfillment_layout_position_id, **kwargs):  # noqa: E501
    ...
    def get_duplicate_fulfillment_layout_position_by_id_with_http_info(self, fulfillment_layout_position_id, **kwargs):  # noqa: E501
        """Get a duplicated a fulfillmentLayoutPosition by id  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_duplicate_fulfillment_layout_position_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `get_duplicate_fulfillment_layout_position_by_id`")  # noqa: E501
    ...
    def get_fulfillment_layout_position_by_filter(self, **kwargs):  # noqa: E501
    ...
    def get_fulfillment_layout_position_by_filter_with_http_info(self, **kwargs):  # noqa: E501
        """Search fulfillmentLayoutPositions by filter  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_fulfillment_layout_position_by_filter" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_fulfillment_layout_position_by_id(self, fulfillment_layout_position_id, **kwargs):  # noqa: E501
    ...
    def get_fulfillment_layout_position_by_id_with_http_info(self, fulfillment_layout_position_id, **kwargs):  # noqa: E501
        """Get a fulfillmentLayoutPosition by id  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_fulfillment_layout_position_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `get_fulfillment_layout_position_by_id`")  # noqa: E501
    ...
    def get_fulfillment_layout_position_files(self, fulfillment_layout_position_id, **kwargs):  # noqa: E501
    ...
    def get_fulfillment_layout_position_files_with_http_info(self, fulfillment_layout_position_id, **kwargs):  # noqa: E501
        """Get the files for a fulfillmentLayoutPosition.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_fulfillment_layout_position_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `get_fulfillment_layout_position_files`")  # noqa: E501
    ...
    def get_fulfillment_layout_position_tags(self, fulfillment_layout_position_id, **kwargs):  # noqa: E501
    ...
    def get_fulfillment_layout_position_tags_with_http_info(self, fulfillment_layout_position_id, **kwargs):  # noqa: E501
        """Get the tags for a fulfillmentLayoutPosition.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_fulfillment_layout_position_tags" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_layout_position_id' is set
        if ('fulfillment_layout_position_id' not in params or
                params['fulfillment_layout_position_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_layout_position_id` when calling `get_fulfillment_layout_position_tags`")  # noqa: E501
