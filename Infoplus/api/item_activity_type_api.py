...
class ItemActivityTypeApi(object):
    ...
    def get_item_activity_type_by_id(self, item_activity_type_id, **kwargs):  # noqa: E501
    ...
    def get_item_activity_type_by_id_with_http_info(self, item_activity_type_id, **kwargs):  # noqa: E501
        """Get an itemActivityType by id  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_item_activity_type_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'item_activity_type_id' is set
        if ('item_activity_type_id' not in params or
                params['item_activity_type_id'] is None):
            raise ValueError("Missing the required parameter `item_activity_type_id` when calling `get_item_activity_type_by_id`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'item_activity_type_id' in params:
            path_params['itemActivityTypeId'] = params['item_activity_type_id']  # noqa: E501
    ...
    def get_item_activity_type_by_search_text(self, **kwargs):  # noqa: E501
    ...
    def get_item_activity_type_by_search_text_with_http_info(self, **kwargs):  # noqa: E501
        """Search itemActivityTypes  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_item_activity_type_by_search_text" % key
                )
            params[key] = val
        del params['kwargs']
