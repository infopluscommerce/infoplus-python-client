...
class LocationBillingTypeApi(object):
    ...
    def add_location_billing_type_file(self, location_billing_type_id, file_name, **kwargs):  # noqa: E501
    ...
    def add_location_billing_type_file_with_http_info(self, location_billing_type_id, file_name, **kwargs):  # noqa: E501
        """Attach a file to a locationBillingType  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_location_billing_type_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_billing_type_id' is set
        if ('location_billing_type_id' not in params or
                params['location_billing_type_id'] is None):
            raise ValueError("Missing the required parameter `location_billing_type_id` when calling `add_location_billing_type_file`")  # noqa: E501
        # verify the required parameter 'file_name' is set
        if ('file_name' not in params or
                params['file_name'] is None):
            raise ValueError("Missing the required parameter `file_name` when calling `add_location_billing_type_file`")  # noqa: E501
    ...
    def add_location_billing_type_file_by_url(self, body, location_billing_type_id, **kwargs):  # noqa: E501
    ...
    def add_location_billing_type_file_by_url_with_http_info(self, body, location_billing_type_id, **kwargs):  # noqa: E501
        """Attach a file to a locationBillingType by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_location_billing_type_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_location_billing_type_file_by_url`")  # noqa: E501
        # verify the required parameter 'location_billing_type_id' is set
        if ('location_billing_type_id' not in params or
                params['location_billing_type_id'] is None):
            raise ValueError("Missing the required parameter `location_billing_type_id` when calling `add_location_billing_type_file_by_url`")  # noqa: E501
    ...
    def delete_location_billing_type_file(self, location_billing_type_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_location_billing_type_file_with_http_info(self, location_billing_type_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a locationBillingType.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_location_billing_type_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_billing_type_id' is set
        if ('location_billing_type_id' not in params or
                params['location_billing_type_id'] is None):
            raise ValueError("Missing the required parameter `location_billing_type_id` when calling `delete_location_billing_type_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_location_billing_type_file`")  # noqa: E501
    ...
    def get_location_billing_type_files(self, location_billing_type_id, **kwargs):  # noqa: E501
    ...
    def get_location_billing_type_files_with_http_info(self, location_billing_type_id, **kwargs):  # noqa: E501
        """Get the files for a locationBillingType.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_location_billing_type_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_billing_type_id' is set
        if ('location_billing_type_id' not in params or
                params['location_billing_type_id'] is None):
            raise ValueError("Missing the required parameter `location_billing_type_id` when calling `get_location_billing_type_files`")  # noqa: E501
