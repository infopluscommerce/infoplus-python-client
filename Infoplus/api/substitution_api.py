...
class SubstitutionApi(object):
    ...
    def add_substitution_file(self, substitution_id, file_name, **kwargs):  # noqa: E501
    ...
    def add_substitution_file_with_http_info(self, substitution_id, file_name, **kwargs):  # noqa: E501
        """Attach a file to a substitution  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_substitution_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'substitution_id' is set
        if ('substitution_id' not in params or
                params['substitution_id'] is None):
            raise ValueError("Missing the required parameter `substitution_id` when calling `add_substitution_file`")  # noqa: E501
        # verify the required parameter 'file_name' is set
        if ('file_name' not in params or
                params['file_name'] is None):
            raise ValueError("Missing the required parameter `file_name` when calling `add_substitution_file`")  # noqa: E501
    ...
    def add_substitution_file_by_url(self, body, substitution_id, **kwargs):  # noqa: E501
    ...
    def add_substitution_file_by_url_with_http_info(self, body, substitution_id, **kwargs):  # noqa: E501
        """Attach a file to a substitution by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_substitution_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_substitution_file_by_url`")  # noqa: E501
        # verify the required parameter 'substitution_id' is set
        if ('substitution_id' not in params or
                params['substitution_id'] is None):
            raise ValueError("Missing the required parameter `substitution_id` when calling `add_substitution_file_by_url`")  # noqa: E501
    ...
    def delete_substitution_file(self, substitution_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_substitution_file_with_http_info(self, substitution_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a substitution.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_substitution_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'substitution_id' is set
        if ('substitution_id' not in params or
                params['substitution_id'] is None):
            raise ValueError("Missing the required parameter `substitution_id` when calling `delete_substitution_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_substitution_file`")  # noqa: E501
    ...
    def get_substitution_files(self, substitution_id, **kwargs):  # noqa: E501
    ...
    def get_substitution_files_with_http_info(self, substitution_id, **kwargs):  # noqa: E501
        """Get the files for a substitution.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_substitution_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'substitution_id' is set
        if ('substitution_id' not in params or
                params['substitution_id'] is None):
            raise ValueError("Missing the required parameter `substitution_id` when calling `get_substitution_files`")  # noqa: E501
