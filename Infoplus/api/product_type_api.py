...
class ProductTypeApi(object):
    ...
    def get_product_type_by_id(self, product_type_id, **kwargs):  # noqa: E501
    ...
    def get_product_type_by_id_with_http_info(self, product_type_id, **kwargs):  # noqa: E501
        """Get a productType by id  # noqa: E501
        ...
        if ('product_type_id' not in params or
                params['product_type_id'] is None):
            raise ValueError("Missing the required parameter `product_type_id` when calling `get_product_type_by_id`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'product_type_id' in params:
            path_params['productTypeId'] = params['product_type_id']  # noqa: E501
    ...
    def get_product_type_by_search_text(self, **kwargs):  # noqa: E501
    ...
    def get_product_type_by_search_text_with_http_info(self, **kwargs):  # noqa: E501
        """Search productTypes  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_product_type_by_search_text" % key
                )
            params[key] = val
        del params['kwargs']
