...
class ItemBuyerApi(object):
    ...
    def add_item_buyer_file_by_url(self, body, item_buyer_id, **kwargs):  # noqa: E501
    ...
    def add_item_buyer_file_by_url_with_http_info(self, body, item_buyer_id, **kwargs):  # noqa: E501
        """Attach a file to an itemBuyer by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_item_buyer_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_item_buyer_file_by_url`")  # noqa: E501
        # verify the required parameter 'item_buyer_id' is set
        if ('item_buyer_id' not in params or
                params['item_buyer_id'] is None):
            raise ValueError("Missing the required parameter `item_buyer_id` when calling `add_item_buyer_file_by_url`")  # noqa: E501
    ...
    def delete_item_buyer_file(self, item_buyer_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_item_buyer_file_with_http_info(self, item_buyer_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for an itemBuyer.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_item_buyer_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'item_buyer_id' is set
        if ('item_buyer_id' not in params or
                params['item_buyer_id'] is None):
            raise ValueError("Missing the required parameter `item_buyer_id` when calling `delete_item_buyer_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_item_buyer_file`")  # noqa: E501
    ...
    def get_item_buyer_files(self, item_buyer_id, **kwargs):  # noqa: E501
    ...
    def get_item_buyer_files_with_http_info(self, item_buyer_id, **kwargs):  # noqa: E501
        """Get the files for an itemBuyer.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_item_buyer_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'item_buyer_id' is set
        if ('item_buyer_id' not in params or
                params['item_buyer_id'] is None):
            raise ValueError("Missing the required parameter `item_buyer_id` when calling `get_item_buyer_files`")  # noqa: E501
