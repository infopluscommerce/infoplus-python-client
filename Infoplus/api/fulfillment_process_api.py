...
class FulfillmentProcessApi(object):
    ...
    def add_fulfillment_process_file_by_url(self, body, fulfillment_process_id, **kwargs):  # noqa: E501
    ...
    def add_fulfillment_process_file_by_url_with_http_info(self, body, fulfillment_process_id, **kwargs):  # noqa: E501
        """Attach a file to a fulfillmentProcess by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_fulfillment_process_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_fulfillment_process_file_by_url`")  # noqa: E501
        # verify the required parameter 'fulfillment_process_id' is set
        if ('fulfillment_process_id' not in params or
                params['fulfillment_process_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_process_id` when calling `add_fulfillment_process_file_by_url`")  # noqa: E501
    ...
    def delete_fulfillment_process_file(self, fulfillment_process_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_fulfillment_process_file_with_http_info(self, fulfillment_process_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a fulfillmentProcess.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_fulfillment_process_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_process_id' is set
        if ('fulfillment_process_id' not in params or
                params['fulfillment_process_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_process_id` when calling `delete_fulfillment_process_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_fulfillment_process_file`")  # noqa: E501
    ...
    def get_fulfillment_process_files(self, fulfillment_process_id, **kwargs):  # noqa: E501
    ...
    def get_fulfillment_process_files_with_http_info(self, fulfillment_process_id, **kwargs):  # noqa: E501
        """Get the files for a fulfillmentProcess.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_fulfillment_process_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fulfillment_process_id' is set
        if ('fulfillment_process_id' not in params or
                params['fulfillment_process_id'] is None):
            raise ValueError("Missing the required parameter `fulfillment_process_id` when calling `get_fulfillment_process_files`")  # noqa: E501
