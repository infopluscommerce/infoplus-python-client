...
class ThirdPartyParcelAccountApi(object):
    ...
    def add_third_party_parcel_account_file(self, third_party_parcel_account_id, file_name, **kwargs):  # noqa: E501
    ...
    def add_third_party_parcel_account_file_with_http_info(self, third_party_parcel_account_id, file_name, **kwargs):  # noqa: E501
        """Attach a file to a thirdPartyParcelAccount  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_third_party_parcel_account_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'third_party_parcel_account_id' is set
        if ('third_party_parcel_account_id' not in params or
                params['third_party_parcel_account_id'] is None):
            raise ValueError("Missing the required parameter `third_party_parcel_account_id` when calling `add_third_party_parcel_account_file`")  # noqa: E501
        # verify the required parameter 'file_name' is set
        if ('file_name' not in params or
                params['file_name'] is None):
            raise ValueError("Missing the required parameter `file_name` when calling `add_third_party_parcel_account_file`")  # noqa: E501
    ...
    def add_third_party_parcel_account_file_by_url(self, body, third_party_parcel_account_id, **kwargs):  # noqa: E501
    ...
    def add_third_party_parcel_account_file_by_url_with_http_info(self, body, third_party_parcel_account_id, **kwargs):  # noqa: E501
        """Attach a file to a thirdPartyParcelAccount by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_third_party_parcel_account_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_third_party_parcel_account_file_by_url`")  # noqa: E501
        # verify the required parameter 'third_party_parcel_account_id' is set
        if ('third_party_parcel_account_id' not in params or
                params['third_party_parcel_account_id'] is None):
            raise ValueError("Missing the required parameter `third_party_parcel_account_id` when calling `add_third_party_parcel_account_file_by_url`")  # noqa: E501
    ...
    def delete_third_party_parcel_account_file(self, third_party_parcel_account_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_third_party_parcel_account_file_with_http_info(self, third_party_parcel_account_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a thirdPartyParcelAccount.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_third_party_parcel_account_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'third_party_parcel_account_id' is set
        if ('third_party_parcel_account_id' not in params or
                params['third_party_parcel_account_id'] is None):
            raise ValueError("Missing the required parameter `third_party_parcel_account_id` when calling `delete_third_party_parcel_account_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_third_party_parcel_account_file`")  # noqa: E501
    ...
    def get_third_party_parcel_account_files(self, third_party_parcel_account_id, **kwargs):  # noqa: E501
    ...
    def get_third_party_parcel_account_files_with_http_info(self, third_party_parcel_account_id, **kwargs):  # noqa: E501
        """Get the files for a thirdPartyParcelAccount.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_third_party_parcel_account_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'third_party_parcel_account_id' is set
        if ('third_party_parcel_account_id' not in params or
                params['third_party_parcel_account_id'] is None):
            raise ValueError("Missing the required parameter `third_party_parcel_account_id` when calling `get_third_party_parcel_account_files`")  # noqa: E501
