...
class BillingCodeActivityApi(object):
    ...
    def add_billing_code_activity_file_by_url(self, body, billing_code_activity_id, **kwargs):  # noqa: E501
    ...
    def add_billing_code_activity_file_by_url_with_http_info(self, body, billing_code_activity_id, **kwargs):  # noqa: E501
        """Attach a file to a billingCodeActivity by URL.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_billing_code_activity_file_by_url" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_billing_code_activity_file_by_url`")  # noqa: E501
        # verify the required parameter 'billing_code_activity_id' is set
        if ('billing_code_activity_id' not in params or
                params['billing_code_activity_id'] is None):
            raise ValueError("Missing the required parameter `billing_code_activity_id` when calling `add_billing_code_activity_file_by_url`")  # noqa: E501
    ...
    def delete_billing_code_activity_file(self, billing_code_activity_id, file_id, **kwargs):  # noqa: E501
    ...
    def delete_billing_code_activity_file_with_http_info(self, billing_code_activity_id, file_id, **kwargs):  # noqa: E501
        """Delete a file for a billingCodeActivity.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_billing_code_activity_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'billing_code_activity_id' is set
        if ('billing_code_activity_id' not in params or
                params['billing_code_activity_id'] is None):
            raise ValueError("Missing the required parameter `billing_code_activity_id` when calling `delete_billing_code_activity_file`")  # noqa: E501
        # verify the required parameter 'file_id' is set
        if ('file_id' not in params or
                params['file_id'] is None):
            raise ValueError("Missing the required parameter `file_id` when calling `delete_billing_code_activity_file`")  # noqa: E501
    ...
    def get_billing_code_activity_files(self, billing_code_activity_id, **kwargs):  # noqa: E501
    ...
    def get_billing_code_activity_files_with_http_info(self, billing_code_activity_id, **kwargs):  # noqa: E501
        """Get the files for a billingCodeActivity.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_billing_code_activity_files" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'billing_code_activity_id' is set
        if ('billing_code_activity_id' not in params or
                params['billing_code_activity_id'] is None):
            raise ValueError("Missing the required parameter `billing_code_activity_id` when calling `get_billing_code_activity_files`")  # noqa: E501
