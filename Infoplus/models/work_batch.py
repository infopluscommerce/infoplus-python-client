...
class WorkBatch(object):
    ...
    def __init__(self, id=None, warehouse_id=None, batch_priority_code=None, assigned_user_id=None, create_date=None, modify_date=None, custom_fields=None):  # noqa: E501
