...
class Carton(object):
    ...
    def __init__(self, id=None, order_no=None, carton_no=None, carton_type_id=None, carton_lpn=None, weight_lbs=None, layout_position=None, custom_fields=None):  # noqa: E501
