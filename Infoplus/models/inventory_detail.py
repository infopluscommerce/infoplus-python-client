...
class InventoryDetail(object):
    ...
    def __init__(self, id=None, warehouse_location_id=None, lob_id=None, sku=None, quantity=None, distribution_date=None, expiration_date=None, quantity_per_inner_pack=None, quantity_per_case=None, quantity_per_pallet=None, estimated_inner_packs=None, estimated_cases=None, estimated_pallets=None, units_per_wrap=None, revision_date=None, production_lot=None, oldest_receipt_date=None, po_no=None, custom_fields=None):  # noqa: E501
