...
class QuickAdjustment(object):
    ...
    def __init__(self, id=None, warehouse_id=None, location_id=None, adjustment_code=None, total_quantity=None, change_quantity=None, message=None, status=None, product_id_tag=None, create_date=None, modify_date=None, custom_fields=None, sku=None):  # noqa: E501
