...
class ParcelAccount(object):
    ...
    def __init__(self, id=None, create_date=None, modify_date=None, carrier_company=None, account_no=None, client=None, ipc_database_id=None, name=None, manifest_partner_id=None, manifest_partner_credentials=None, custom_fields=None):  # noqa: E501
