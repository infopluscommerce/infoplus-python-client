...
class ParcelAccount(object):
    ...
    def __init__(self, id=None, create_date=None, modify_date=None, carrier_company=None, account_no=None, lob_id=None, order_source_id=None, client=None, ipc_database_id=None, name=None, manifest_partner=None, manifest_partner_id=None, manifest_partner_credentials=None, custom_fields=None):  # noqa: E501
        ...
        self.name = name
        if manifest_partner is not None:
            self.manifest_partner = manifest_partner
    ...
    @property
    def manifest_partner(self):
        """Gets the manifest_partner of this ParcelAccount.  # noqa: E501


        :return: The manifest_partner of this ParcelAccount.  # noqa: E501
        :rtype: int
        """
        return self._manifest_partner

    @manifest_partner.setter
    def manifest_partner(self, manifest_partner):
        """Sets the manifest_partner of this ParcelAccount.


        :param manifest_partner: The manifest_partner of this ParcelAccount.  # noqa: E501
        :type: int
        """

        self._manifest_partner = manifest_partner
