...
class FulfillmentPlan(object):
    ...
    def __init__(self, id=None, create_date=None, modify_date=None, name=None, description=None, warehouse_id=None, priority_code=None, last_run_time=None, order_smart_filter_id=None, location_smart_filter_id=None, max_orders=None, batch_size_max=None, batch_size_min=None, max_sk_us=None, max_cartons=None, version=None, is_mass_distribution=False, create_pick_work=False, picking_rule=None, layout_rule=None, pick_sort_rule=None, location_sort=None, create_pick_list=False, pick_list_format=None, pick_list_layout=None, pick_list_group=None, pick_list_sort=None, pick_list_location_sort=None, create_pick_summary=False, pick_summary_format=None, pick_summary_layout=None, pick_summary_sort=None, pick_scan_scheme_id=None, cartonize_orders=False, cartonization_script_id=None, auto_ship_casebreak_cartons=False, auto_ship_orders=False, pre_generate_parcel_labels=False, label_sort=None, create_packing_slip=None, override_packing_slip_template_id=None, create_order_assembly_guide=False, create_order_invoice=None, override_order_invoice_template_id=None, send_to_external_shipping_system=False, external_shipping_system_id=None, custom_fields=None):  # noqa: E501
    ...
    @property
    def max_sk_us(self):
        """Gets the max_sk_us of this FulfillmentPlan.  # noqa: E501


        :return: The max_sk_us of this FulfillmentPlan.  # noqa: E501
        :rtype: int
        """
    ...
    def max_sk_us(self, max_sk_us):
        """Sets the max_sk_us of this FulfillmentPlan.


        :param max_sk_us: The max_sk_us of this FulfillmentPlan.  # noqa: E501
        :type: int
        """
