...
class JobTimeActivity(object):
    ...
    def __init__(self, id=None, imported_id=None, create_date=None, modify_date=None, date=None, second_duration=None, user_id=None, email=None, lob_id=None, job_type_id=None, job_type_name=None, note=None, custom_fields=None):  # noqa: E501
