...
from Infoplus.models.gs1128_label import GS1128Label  # noqa: F401,E501
...
class PackingDetail(object):
    ...
    swagger_types = {
        ...
        'line_item_id': 'int',
        'quantity': 'int',
        'carton_gs1128_label': 'list[GS1128Label]',
        'pallet_gs1128_label': 'list[GS1128Label]',
    ...
    def carton_gs1128_label(self, carton_gs1128_label):
        ...
        :type: list[GS1128Label]
        """
        if carton_gs1128_label is None:
            raise ValueError("Invalid value for `carton_gs1128_label`, must not be `None`")  # noqa: E501
    ...
    def pallet_gs1128_label(self, pallet_gs1128_label):
        ...
        :type: list[GS1128Label]
        """
        if pallet_gs1128_label is None:
            raise ValueError("Invalid value for `pallet_gs1128_label`, must not be `None`")  # noqa: E501
