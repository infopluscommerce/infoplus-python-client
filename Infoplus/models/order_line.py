...
class OrderLine(object):
    ...
    def __init__(self, id=None, order_no=None, lob_id=None, sku=None, po_no_id=None, ordered_qty=None, allowed_qty=None, shipped_qty=None, backorder_qty=None, rev_date=None, charge_code=None, distribution_code=None, upc=None, vendor_sku=None, order_source_sku=None, unit_cost=None, unit_sell=None, unit_discount=None, extended_cost=None, extended_sell=None, extended_discount=None, nc_extended_sell=None, item_weight=None, production_lot=None, expiration_date=None, weight_per_wrap=None, sector=None, order_assembly_instructions=None, item_account_code_id=None, item_legacy_low_stock_contact_id=None, item_major_group_id=None, item_sub_group_id=None, item_product_code_id=None, item_summary_code_id=None, fulfillment_channel=None, dynamic_kit_component_list=None, custom_fields=None):  # noqa: E501
