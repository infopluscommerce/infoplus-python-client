...
class BillingCodeActivity(object):
    ...
    def __init__(self, id=None, imported_id=None, create_date=None, modify_date=None, date=None, quantity=None, lob_id=None, user_id=None, email=None, billing_code_type_id=None, billing_code_type_name=None, note=None, record_type_name=None, record_type_id=None, record_id=None, custom_fields=None):  # noqa: E501
