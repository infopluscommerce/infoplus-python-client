...
class OmsOrder(object):
    ...
    def __init__(self, lob_id=None, external_id=None, oms_order_no=None, total=None, order_status=None, order_entry_program_id=None, entered_by_id=None, id=None, create_date=None, modify_date=None, next_oms_order_id=None, customer_id=None, tax=None, shipping_handling=None, sh_override_amount=None, integration_partner_id=None, order_source_id=None, batch_no=None, is_gift=False, gift_message=None, email_recipient=False, mail_recipient=False, key_code=None, key_code_description=None, dist_charges=None, sub_total=None, custom_fields=None):  # noqa: E501
        ...
        if entered_by_id is not None:
            self.entered_by_id = entered_by_id
        if id is not None:
            self.id = id
    ...
    @property
    def entered_by_id(self):
        """Gets the entered_by_id of this OmsOrder.  # noqa: E501


        :return: The entered_by_id of this OmsOrder.  # noqa: E501
        :rtype: int
        """
        return self._entered_by_id

    @entered_by_id.setter
    def entered_by_id(self, entered_by_id):
        """Sets the entered_by_id of this OmsOrder.


        :param entered_by_id: The entered_by_id of this OmsOrder.  # noqa: E501
        :type: int
        """

        self._entered_by_id = entered_by_id
