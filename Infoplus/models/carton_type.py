...
class CartonType(object):
    ...
    def __init__(self, id=None, abbreviation=None, name=None, length_in=None, width_in=None, height_in=None, inner_length_in=None, inner_width_in=None, inner_height_in=None, weight_lbs=None, lob_id=None, is_active=False, predefined_package_type_id=None, type=None, custom_fields=None):  # noqa: E501
