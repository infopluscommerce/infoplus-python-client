...
class OverrideReturnAddress(object):
    ...
    def __init__(self, id=None, create_date=None, modify_date=None, lob_id=None, warehouse_id=None, order_source_id=None, name=None, attention=None, street=None, street2=None, city=None, state=None, zip=None, country=None, phone=None, custom_fields=None):  # noqa: E501
