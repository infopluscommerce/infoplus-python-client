...
class ExternalShipment(object):
    ...
    def __init__(self, id=None, create_date=None, modify_date=None, order_id=None, carrier_id=None, parcel_account_id=None, third_party_parcel_account_id=None, freight=None, tracking_no=None, dim1_in=None, dim2_in=None, dim3_in=None, weight_lbs=None, dim_weight=None, residential=False, zone=None, status=None, custom_fields=None):  # noqa: E501
