...
class LineOfBusiness(object):
    ...
    def __init__(self, id=None, name=None, code=None, label=None, default_warehouse_service_type_id=None, default_sla_service_days=None, default_sla_cutoff_time=None, on_hold=False, on_hold_reason=None, create_date=None, modify_date=None, custom_fields=None):  # noqa: E501
