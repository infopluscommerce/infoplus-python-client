...
class CustomerInvoiceTemplateLine(object):
    ...
    def __init__(self, id=None, create_date=None, modify_date=None, lob_id=None, description=None, seq_no=None, account_code=None, active=False, include_if_zero=False, department=None, item_code=None, invoice_template_id=None, billing_rule_id=None, price_level_mode=None, script_id=None, price_level_list=None, custom_fields=None):  # noqa: E501
