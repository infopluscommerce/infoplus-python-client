...
class WarehouseDocumentApi(object):
    ...
    def get_duplicate_warehouse_document_by_id(self, warehouse_document_id, **kwargs):
        ...
        resource_path = '/v2.0/warehouseDocument/duplicate/{warehouseDocumentId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_warehouse_document_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/warehouseDocument/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_warehouse_document_by_id(self, warehouse_document_id, **kwargs):
        ...
        resource_path = '/v2.0/warehouseDocument/{warehouseDocumentId}'.replace('{format}', 'json')
        path_params = {}
        if 'warehouse_document_id' in params:
            path_params['warehouseDocumentId'] = params['warehouse_document_id']
    ...
    def update_warehouse_document_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/warehouseDocument/customFields'.replace('{format}', 'json')
        path_params = {}
