...
class AisleApi(object):
    ...
    def get_duplicate_aisle_by_id(self, aisle_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_duplicate_aisle_by_id(aisle_id, callback=callback_function)
    ...
    def update_aisle_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_aisle_custom_fields(body, callback=callback_function)
