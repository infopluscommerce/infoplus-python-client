...
class CartonContentApi(object):
    ...
    def add_carton_content(self, body, **kwargs):
        ...
        resource_path = '/beta/cartonContent'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_carton_content_by_filter(self, **kwargs):
        ...
        resource_path = '/beta/cartonContent/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_carton_content_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/beta/cartonContent/customFields'.replace('{format}', 'json')
        path_params = {}
