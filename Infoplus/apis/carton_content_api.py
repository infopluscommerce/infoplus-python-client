...
class CartonContentApi(object):
    ...
    def add_carton_content(self, body, **kwargs):
        ...
        resource_path = '/v1.0/cartonContent'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_carton_content(self, carton_content_id, **kwargs):
        ...
        resource_path = '/v1.0/cartonContent/{cartonContentId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_carton_content_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/cartonContent/search'.replace('{format}', 'json')
        path_params = {}
