...
class CartonContentApi(object):
    ...
    def add_carton_content(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_carton_content(body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_carton_content`")

        resource_path = '/v2.0/cartonContent'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_carton_content(self, carton_content_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_carton_content(carton_content_id, callback=callback_function)
        ...
        if ('carton_content_id' not in params) or (params['carton_content_id'] is None):
            raise ValueError("Missing the required parameter `carton_content_id` when calling `delete_carton_content`")

        resource_path = '/v2.0/cartonContent/{cartonContentId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_carton_content_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_carton_content_by_filter(callback=callback_function)
        ...
        resource_path = '/v2.0/cartonContent/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[CartonContent]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_carton_content_by_id(self, carton_content_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_carton_content_by_id(carton_content_id, callback=callback_function)
    ...
    def get_duplicate_carton_content_by_id(self, carton_content_id, **kwargs):
        ...
        resource_path = '/v2.0/cartonContent/duplicate/{cartonContentId}'.replace('{format}', 'json')
        path_params = {}
        if 'carton_content_id' in params:
            path_params['cartonContentId'] = params['carton_content_id']
    ...
    def update_carton_content(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_carton_content(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_carton_content`")
    ...
    def update_carton_content_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_carton_content_custom_fields(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_carton_content_custom_fields`")

        resource_path = '/v2.0/cartonContent/customFields'.replace('{format}', 'json')
        path_params = {}
