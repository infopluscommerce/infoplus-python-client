...
class IntegrationPartnerApi(object):
    ...
    def get_integration_partner_by_id(self, integration_partner_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_integration_partner_by_id(integration_partner_id, callback=callback_function)
        ...
        all_params = ['integration_partner_id']
        ...
        resource_path = '/v2.0/integrationPartner/{integrationPartnerId}'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            response_type='IntegrationPartner',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_integration_partner_by_search_text(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_integration_partner_by_search_text(callback=callback_function)
        ...
        resource_path = '/v2.0/integrationPartner/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[IntegrationPartner]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
