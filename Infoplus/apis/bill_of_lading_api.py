...
class BillOfLadingApi(object):
    ...
    def add_bill_of_lading(self, body, **kwargs):
        ...
        resource_path = '/v1.0/billOfLading'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_bill_of_lading(self, bill_of_lading_id, **kwargs):
        ...
        resource_path = '/v1.0/billOfLading/{billOfLadingId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_bill_of_lading_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/billOfLading/search'.replace('{format}', 'json')
        path_params = {}
