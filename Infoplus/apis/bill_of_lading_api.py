...
class BillOfLadingApi(object):
    ...
    def add_bill_of_lading(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_bill_of_lading(body, callback=callback_function)
    ...
    def delete_bill_of_lading(self, bill_of_lading_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_bill_of_lading(bill_of_lading_id, callback=callback_function)
    ...
    def get_bill_of_lading_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_bill_of_lading_by_filter(callback=callback_function)
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[BillOfLading]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_bill_of_lading_by_id(self, bill_of_lading_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_bill_of_lading_by_id(bill_of_lading_id, callback=callback_function)
    ...
    def get_duplicate_bill_of_lading_by_id(self, bill_of_lading_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_duplicate_bill_of_lading_by_id(bill_of_lading_id, callback=callback_function)
    ...
    def update_bill_of_lading(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_bill_of_lading(body, callback=callback_function)
    ...
    def update_bill_of_lading_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_bill_of_lading_custom_fields(body, callback=callback_function)
