...
class SubstitutionApi(object):
    ...
    def add_substitution(self, body, **kwargs):
        ...
        resource_path = '/v2.0/substitution'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_substitution(self, substitution_id, **kwargs):
        ...
        resource_path = '/v2.0/substitution/{substitutionId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_substitution_by_id(self, substitution_id, **kwargs):
        ...
        resource_path = '/v2.0/substitution/duplicate/{substitutionId}'.replace('{format}', 'json')
        path_params = {}
        if 'substitution_id' in params:
            path_params['substitutionId'] = params['substitution_id']
    ...
    def get_substitution_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/substitution/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_substitution_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/substitution/customFields'.replace('{format}', 'json')
        path_params = {}
