...
class ProductionLotApi(object):
    ...
    def get_duplicate_production_lot_by_id(self, production_lot_id, **kwargs):
        ...
        resource_path = '/v2.0/productionLot/duplicate/{productionLotId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_production_lot_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/productionLot/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_production_lot_by_id(self, production_lot_id, **kwargs):
        ...
        resource_path = '/v2.0/productionLot/{productionLotId}'.replace('{format}', 'json')
        path_params = {}
        if 'production_lot_id' in params:
            path_params['productionLotId'] = params['production_lot_id']
    ...
    def update_production_lot_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/productionLot/customFields'.replace('{format}', 'json')
        path_params = {}
