...
class ScheduledPlanLogApi(object):
    ...
    def get_duplicate_scheduled_plan_log_by_id(self, scheduled_plan_log_id, **kwargs):
        ...
        resource_path = '/v2.0/scheduledPlanLog/duplicate/{scheduledPlanLogId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_scheduled_plan_log_by_filter(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_scheduled_plan_log_by_filter(callback=callback_function)
        ...
        resource_path = '/v2.0/scheduledPlanLog/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[ScheduledPlanLog]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_scheduled_plan_log_by_id(self, scheduled_plan_log_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_scheduled_plan_log_by_id(scheduled_plan_log_id, callback=callback_function)
        ...
        # verify the required parameter 'scheduled_plan_log_id' is set
        if ('scheduled_plan_log_id' not in params) or (params['scheduled_plan_log_id'] is None):
            raise ValueError("Missing the required parameter `scheduled_plan_log_id` when calling `get_scheduled_plan_log_by_id`")

        resource_path = '/v2.0/scheduledPlanLog/{scheduledPlanLogId}'.replace('{format}', 'json')
        path_params = {}
        if 'scheduled_plan_log_id' in params:
            path_params['scheduledPlanLogId'] = params['scheduled_plan_log_id']
