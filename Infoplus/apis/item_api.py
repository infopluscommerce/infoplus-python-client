...
class ItemApi(object):
    ...
    def add_item(self, body, **kwargs):
        ...
        resource_path = '/v2.0/item'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_item(self, item_id, **kwargs):
        ...
        resource_path = '/v2.0/item/{itemId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_by_sku(self, lob_id, sku, **kwargs):
        ...
        resource_path = '/v2.0/item/getBySKU'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_item_by_id(self, item_id, **kwargs):
        ...
        resource_path = '/v2.0/item/duplicate/{itemId}'.replace('{format}', 'json')
        path_params = {}
        if 'item_id' in params:
            path_params['itemId'] = params['item_id']
    ...
    def get_item_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/item/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_item_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/item/customFields'.replace('{format}', 'json')
        path_params = {}
