...
class QuickReceiptApi(object):
    ...
    def add_quick_receipt(self, body, **kwargs):
        ...
        resource_path = '/v1.0/quickReceipt'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_quick_receipt(self, quick_receipt_id, **kwargs):
        ...
        resource_path = '/v1.0/quickReceipt/{quickReceiptId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_quick_receipt_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/quickReceipt/search'.replace('{format}', 'json')
        path_params = {}
