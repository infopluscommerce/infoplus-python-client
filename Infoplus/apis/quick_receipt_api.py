...
class QuickReceiptApi(object):
    ...
    def add_quick_receipt(self, body, **kwargs):
        ...
        resource_path = '/v2.0/quickReceipt'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_quick_receipt(self, quick_receipt_id, **kwargs):
        ...
        resource_path = '/v2.0/quickReceipt/{quickReceiptId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_quick_receipt_by_id(self, quick_receipt_id, **kwargs):
        ...
        resource_path = '/v2.0/quickReceipt/duplicate/{quickReceiptId}'.replace('{format}', 'json')
        path_params = {}
        if 'quick_receipt_id' in params:
            path_params['quickReceiptId'] = params['quick_receipt_id']
    ...
    def get_quick_receipt_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/quickReceipt/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_quick_receipt_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/quickReceipt/customFields'.replace('{format}', 'json')
        path_params = {}
