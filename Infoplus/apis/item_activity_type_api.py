...
class ItemActivityTypeApi(object):
    ...
    def get_item_activity_type_by_id(self, item_activity_type_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_item_activity_type_by_id(item_activity_type_id, callback=callback_function)
        ...
        all_params = ['item_activity_type_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            response_type='ItemActivityType',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_item_activity_type_by_search_text(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_item_activity_type_by_search_text(callback=callback_function)
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[ItemActivityType]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
