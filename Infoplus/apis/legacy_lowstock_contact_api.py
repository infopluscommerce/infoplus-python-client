...
class LegacyLowstockContactApi(object):
    ...
    def add_legacy_lowstock_contact(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_legacy_lowstock_contact(body, callback=callback_function)
    ...
    def delete_legacy_lowstock_contact(self, legacy_lowstock_contact_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_legacy_lowstock_contact(legacy_lowstock_contact_id, callback=callback_function)
    ...
    def get_duplicate_legacy_lowstock_contact_by_id(self, legacy_lowstock_contact_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_duplicate_legacy_lowstock_contact_by_id(legacy_lowstock_contact_id, callback=callback_function)
    ...
    def get_legacy_lowstock_contact_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_legacy_lowstock_contact_by_filter(callback=callback_function)
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[LegacyLowstockContact]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_legacy_lowstock_contact_by_id(self, legacy_lowstock_contact_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_legacy_lowstock_contact_by_id(legacy_lowstock_contact_id, callback=callback_function)
    ...
    def update_legacy_lowstock_contact(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_legacy_lowstock_contact(body, callback=callback_function)
