...
class ProductTypeApi(object):
    ...
    def get_product_type_by_id(self, product_type_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_product_type_by_id(product_type_id, callback=callback_function)
        ...
        resource_path = '/v1.0/productType/{productTypeId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_product_type_by_search_text(self, **kwargs):
        """
        Search productTypes
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_product_type_by_search_text(callback=callback_function)
        ...
        resource_path = '/v1.0/productType/search'.replace('{format}', 'json')
        path_params = {}
