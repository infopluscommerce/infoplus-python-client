...
class ReplenishmentProcessApi(object):
    ...
    def get_replenishment_process_by_filter(self, **kwargs):
        ...
        resource_path = '/beta/replenishmentProcess/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_replenishment_process_by_id(self, replenishment_process_id, **kwargs):
        ...
        resource_path = '/beta/replenishmentProcess/{replenishmentProcessId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_replenishment_process_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/beta/replenishmentProcess/customFields'.replace('{format}', 'json')
        path_params = {}
