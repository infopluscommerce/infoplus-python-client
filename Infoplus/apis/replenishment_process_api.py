...
class ReplenishmentProcessApi(object):
    ...
    def get_duplicate_replenishment_process_by_id(self, replenishment_process_id, **kwargs):
        ...
        resource_path = '/v2.0/replenishmentProcess/duplicate/{replenishmentProcessId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_replenishment_process_by_filter(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_replenishment_process_by_filter(callback=callback_function)
        ...
        resource_path = '/v2.0/replenishmentProcess/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[ReplenishmentProcess]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_replenishment_process_by_id(self, replenishment_process_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_replenishment_process_by_id(replenishment_process_id, callback=callback_function)
        ...
        # verify the required parameter 'replenishment_process_id' is set
        if ('replenishment_process_id' not in params) or (params['replenishment_process_id'] is None):
            raise ValueError("Missing the required parameter `replenishment_process_id` when calling `get_replenishment_process_by_id`")

        resource_path = '/v2.0/replenishmentProcess/{replenishmentProcessId}'.replace('{format}', 'json')
        path_params = {}
        if 'replenishment_process_id' in params:
            path_params['replenishmentProcessId'] = params['replenishment_process_id']
    ...
    def update_replenishment_process_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_replenishment_process_custom_fields(body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_replenishment_process_custom_fields`")

        resource_path = '/v2.0/replenishmentProcess/customFields'.replace('{format}', 'json')
        path_params = {}
