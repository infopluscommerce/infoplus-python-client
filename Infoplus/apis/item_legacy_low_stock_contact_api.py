...
"""
ItemLegacyLowStockContactApi.py
...
class ItemLegacyLowStockContactApi(object):
    """
    ...
    def get_item_legacy_low_stock_contact_by_search_text(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_item_legacy_low_stock_contact_by_search_text(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_item_legacy_low_stock_contact_by_search_text" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            response_type='list[ItemLegacyLowStockContact]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_translate_low_stock_contact_by_id(self, item_legacy_low_stock_contact_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_translate_low_stock_contact_by_id(item_legacy_low_stock_contact_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str item_legacy_low_stock_contact_id: Id of itemLegacyLowStockContact to be returned. (required)
        :return: ItemLegacyLowStockContact
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['item_legacy_low_stock_contact_id']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_translate_low_stock_contact_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ItemLegacyLowStockContact',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
