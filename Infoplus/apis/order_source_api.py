...
class OrderSourceApi(object):
    ...
    def add_order_source(self, body, **kwargs):
        ...
        resource_path = '/v2.0/orderSource'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_order_source(self, order_source_id, **kwargs):
        ...
        resource_path = '/v2.0/orderSource/{orderSourceId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_order_source_by_id(self, order_source_id, **kwargs):
        ...
        resource_path = '/v2.0/orderSource/duplicate/{orderSourceId}'.replace('{format}', 'json')
        path_params = {}
        if 'order_source_id' in params:
            path_params['orderSourceId'] = params['order_source_id']
    ...
    def get_order_source_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/orderSource/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_order_source_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/orderSource/customFields'.replace('{format}', 'json')
        path_params = {}
