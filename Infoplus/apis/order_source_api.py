...
class OrderSourceApi(object):
    ...
    def add_order_source(self, body, **kwargs):
        ...
        resource_path = '/v1.0/orderSource'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_order_source(self, order_source_id, **kwargs):
        ...
        resource_path = '/v1.0/orderSource/{orderSourceId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_order_source_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/orderSource/search'.replace('{format}', 'json')
        path_params = {}
