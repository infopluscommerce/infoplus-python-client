...
class LocationAddressSchemeApi(object):
    ...
    def add_location_address_scheme(self, body, **kwargs):
        ...
        resource_path = '/v2.0/locationAddressScheme'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_location_address_scheme(self, location_address_scheme_id, **kwargs):
        ...
        resource_path = '/v2.0/locationAddressScheme/{locationAddressSchemeId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_location_address_scheme_by_id(self, location_address_scheme_id, **kwargs):
        ...
        resource_path = '/v2.0/locationAddressScheme/duplicate/{locationAddressSchemeId}'.replace('{format}', 'json')
        path_params = {}
        if 'location_address_scheme_id' in params:
            path_params['locationAddressSchemeId'] = params['location_address_scheme_id']
    ...
    def get_location_address_scheme_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/locationAddressScheme/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_location_address_scheme_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/locationAddressScheme/customFields'.replace('{format}', 'json')
        path_params = {}
