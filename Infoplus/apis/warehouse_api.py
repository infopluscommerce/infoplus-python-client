...
class WarehouseApi(object):
    ...
    def get_warehouse_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/warehouse/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_warehouse_by_id(self, warehouse_id, **kwargs):
        ...
        resource_path = '/v1.0/warehouse/{warehouseId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_warehouse(self, body, **kwargs):
        ...
        resource_path = '/v1.0/warehouse'.replace('{format}', 'json')
        path_params = {}
