...
class BillingCodeApi(object):
    ...
    def add_billing_code(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_billing_code(body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_billing_code`")

        resource_path = '/v2.0/billingCode'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_billing_code(self, billing_code_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_billing_code(billing_code_id, callback=callback_function)
        ...
        if ('billing_code_id' not in params) or (params['billing_code_id'] is None):
            raise ValueError("Missing the required parameter `billing_code_id` when calling `delete_billing_code`")

        resource_path = '/v2.0/billingCode/{billingCodeId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_billing_code_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_billing_code_by_filter(callback=callback_function)
        ...
        resource_path = '/v2.0/billingCode/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[BillingCode]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_billing_code_by_id(self, billing_code_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_billing_code_by_id(billing_code_id, callback=callback_function)
    ...
    def get_duplicate_billing_code_by_id(self, billing_code_id, **kwargs):
        ...
        resource_path = '/v2.0/billingCode/duplicate/{billingCodeId}'.replace('{format}', 'json')
        path_params = {}
        if 'billing_code_id' in params:
            path_params['billingCodeId'] = params['billing_code_id']
    ...
    def update_billing_code(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_billing_code(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_billing_code`")
    ...
    def update_billing_code_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_billing_code_custom_fields(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_billing_code_custom_fields`")

        resource_path = '/v2.0/billingCode/customFields'.replace('{format}', 'json')
        path_params = {}
