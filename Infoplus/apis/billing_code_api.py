...
class BillingCodeApi(object):
    ...
    def add_billing_code(self, body, **kwargs):
        ...
        resource_path = '/v1.0/billingCode'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_billing_code(self, billing_code_id, **kwargs):
        ...
        resource_path = '/v1.0/billingCode/{billingCodeId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_billing_code_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/billingCode/search'.replace('{format}', 'json')
        path_params = {}
