...
class BillingCodeApi(object):
    ...
    def add_billing_code(self, body, **kwargs):
        ...
        resource_path = '/beta/billingCode'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_billing_code_by_filter(self, **kwargs):
        ...
        resource_path = '/beta/billingCode/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_billing_code_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/beta/billingCode/customFields'.replace('{format}', 'json')
        path_params = {}
