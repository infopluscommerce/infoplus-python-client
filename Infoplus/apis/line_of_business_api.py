...
class LineOfBusinessApi(object):
    ...
    def get_line_of_business_by_id(self, line_of_business_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_line_of_business_by_id(line_of_business_id, callback=callback_function)
        ...
        all_params = ['line_of_business_id']
        ...
        resource_path = '/v2.0/lineOfBusiness/{lineOfBusinessId}'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            response_type='LineOfBusiness',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_line_of_business_by_search_text(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_line_of_business_by_search_text(callback=callback_function)
        ...
        resource_path = '/v2.0/lineOfBusiness/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[LineOfBusiness]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
