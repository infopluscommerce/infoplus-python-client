...
class EmailTemplateApi(object):
    ...
    def add_email_template(self, body, **kwargs):
        ...
        resource_path = '/v1.0/emailTemplate'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_email_template(self, email_template_id, **kwargs):
        ...
        resource_path = '/v1.0/emailTemplate/{emailTemplateId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_email_template_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/emailTemplate/search'.replace('{format}', 'json')
        path_params = {}
