...
class CustomerApi(object):
    ...
    def add_customer(self, body, **kwargs):
        ...
        resource_path = '/v1.0/customer'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_customer(self, customer_id, **kwargs):
        ...
        resource_path = '/v1.0/customer/{customerId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_customer_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/customer/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_customer_byget_by_customer_no(self, lob_id, customer_no, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_customer_byget_by_customer_no(lob_id, customer_no, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customer_byget_by_customer_no" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('lob_id' not in params) or (params['lob_id'] is None):
            raise ValueError("Missing the required parameter `lob_id` when calling `get_customer_byget_by_customer_no`")
        # verify the required parameter 'customer_no' is set
        if ('customer_no' not in params) or (params['customer_no'] is None):
            raise ValueError("Missing the required parameter `customer_no` when calling `get_customer_byget_by_customer_no`")

        resource_path = '/v1.0/customer/getByCustomerNo'.replace('{format}', 'json')
        path_params = {}
