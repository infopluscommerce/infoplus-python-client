...
class ParcelAccountApi(object):
    ...
    def get_duplicate_parcel_account_by_id(self, parcel_account_id, **kwargs):
        ...
        resource_path = '/v2.0/parcelAccount/duplicate/{parcelAccountId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_parcel_account_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/parcelAccount/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_parcel_account_by_id(self, parcel_account_id, **kwargs):
        ...
        resource_path = '/v2.0/parcelAccount/{parcelAccountId}'.replace('{format}', 'json')
        path_params = {}
        if 'parcel_account_id' in params:
            path_params['parcelAccountId'] = params['parcel_account_id']
    ...
    def update_parcel_account_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/parcelAccount/customFields'.replace('{format}', 'json')
        path_params = {}
