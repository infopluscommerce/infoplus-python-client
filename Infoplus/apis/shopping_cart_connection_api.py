...
class ShoppingCartConnectionApi(object):
    ...
    def add_shopping_cart_connection(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_shopping_cart_connection(body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_shopping_cart_connection`")

        resource_path = '/v2.0/shoppingCartConnection'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_shopping_cart_connection(self, shopping_cart_connection_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_shopping_cart_connection(shopping_cart_connection_id, callback=callback_function)
        ...
        if ('shopping_cart_connection_id' not in params) or (params['shopping_cart_connection_id'] is None):
            raise ValueError("Missing the required parameter `shopping_cart_connection_id` when calling `delete_shopping_cart_connection`")

        resource_path = '/v2.0/shoppingCartConnection/{shoppingCartConnectionId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_shopping_cart_connection_by_id(self, shopping_cart_connection_id, **kwargs):
        ...
        resource_path = '/v2.0/shoppingCartConnection/duplicate/{shoppingCartConnectionId}'.replace('{format}', 'json')
        path_params = {}
        if 'shopping_cart_connection_id' in params:
            path_params['shoppingCartConnectionId'] = params['shopping_cart_connection_id']
    ...
    def get_shopping_cart_connection_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_shopping_cart_connection_by_filter(callback=callback_function)
        ...
        resource_path = '/v2.0/shoppingCartConnection/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[ShoppingCartConnection]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_shopping_cart_connection_by_id(self, shopping_cart_connection_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_shopping_cart_connection_by_id(shopping_cart_connection_id, callback=callback_function)
        ...
        # verify the required parameter 'shopping_cart_connection_id' is set
        if ('shopping_cart_connection_id' not in params) or (params['shopping_cart_connection_id'] is None):
            raise ValueError("Missing the required parameter `shopping_cart_connection_id` when calling `get_shopping_cart_connection_by_id`")
    ...
    def update_shopping_cart_connection(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_shopping_cart_connection(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_shopping_cart_connection`")
    ...
    def update_shopping_cart_connection_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_shopping_cart_connection_custom_fields(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_shopping_cart_connection_custom_fields`")

        resource_path = '/v2.0/shoppingCartConnection/customFields'.replace('{format}', 'json')
        path_params = {}
