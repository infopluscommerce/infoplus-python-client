...
class OrderLoadProgramApi(object):
    ...
    def get_order_load_program_by_search_text(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_order_load_program_by_search_text(callback=callback_function)
        ...
        resource_path = '/v2.0/orderLoadProgram/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            response_type='list[OrderLoadProgram]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_req_load_program_by_id(self, order_load_program_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_req_load_program_by_id(order_load_program_id, callback=callback_function)
        ...
        all_params = ['order_load_program_id']
        all_params.append('callback')
        ...
        resource_path = '/v2.0/orderLoadProgram/{orderLoadProgramId}'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='OrderLoadProgram',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
