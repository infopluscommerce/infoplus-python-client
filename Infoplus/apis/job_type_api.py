...
class JobTypeApi(object):
    ...
    def add_job_type(self, body, **kwargs):
        """
        Create a jobType
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_job_type(body, callback=callback_function)
        ...
        resource_path = '/v2.0/jobType'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_job_type(self, job_type_id, **kwargs):
        """
        Delete a jobType
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_job_type(job_type_id, callback=callback_function)
        ...
        resource_path = '/v2.0/jobType/{jobTypeId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_job_type_by_id(self, job_type_id, **kwargs):
        ...
        resource_path = '/v2.0/jobType/duplicate/{jobTypeId}'.replace('{format}', 'json')
        path_params = {}
        if 'job_type_id' in params:
            path_params['jobTypeId'] = params['job_type_id']
    ...
    def get_job_type_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_job_type_by_filter(callback=callback_function)
        ...
        resource_path = '/v2.0/jobType/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[JobType]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_job_type_by_id(self, job_type_id, **kwargs):
        """
        Get a jobType by id
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_job_type_by_id(job_type_id, callback=callback_function)
    ...
    def update_job_type(self, body, **kwargs):
        """
        Update a jobType
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_job_type(body, callback=callback_function)
    ...
    def update_job_type_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/jobType/customFields'.replace('{format}', 'json')
        path_params = {}
