...
class LowStockApi(object):
    ...
    def get_duplicate_low_stock_by_id(self, low_stock_id, **kwargs):
        ...
        resource_path = '/v2.0/lowStock/duplicate/{lowStockId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_low_stock_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/lowStock/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_low_stock_by_id(self, low_stock_id, **kwargs):
        ...
        resource_path = '/v2.0/lowStock/{lowStockId}'.replace('{format}', 'json')
        path_params = {}
        if 'low_stock_id' in params:
            path_params['lowStockId'] = params['low_stock_id']
