...
class VendorApi(object):
    ...
    def add_vendor(self, body, **kwargs):
        ...
        resource_path = '/v1.0/vendor'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_vendor(self, vendor_id, **kwargs):
        ...
        resource_path = '/v1.0/vendor/{vendorId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_vendor_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/vendor/search'.replace('{format}', 'json')
        path_params = {}
