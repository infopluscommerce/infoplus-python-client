...
class ZoneApi(object):
    ...
    def add_zone(self, body, **kwargs):
        ...
        resource_path = '/v2.0/zone'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_zone(self, zone_id, **kwargs):
        ...
        resource_path = '/v2.0/zone/{zoneId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_zone_by_id(self, zone_id, **kwargs):
        ...
        resource_path = '/v2.0/zone/duplicate/{zoneId}'.replace('{format}', 'json')
        path_params = {}
        if 'zone_id' in params:
            path_params['zoneId'] = params['zone_id']
    ...
    def get_zone_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/zone/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_zone_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/zone/customFields'.replace('{format}', 'json')
        path_params = {}
