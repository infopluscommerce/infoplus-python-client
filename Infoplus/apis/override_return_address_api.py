...
class OverrideReturnAddressApi(object):
    ...
    def add_override_return_address(self, body, **kwargs):
        ...
        resource_path = '/v2.0/overrideReturnAddress'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_override_return_address(self, override_return_address_id, **kwargs):
        ...
        resource_path = '/v2.0/overrideReturnAddress/{overrideReturnAddressId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_override_return_address_by_id(self, override_return_address_id, **kwargs):
        ...
        resource_path = '/v2.0/overrideReturnAddress/duplicate/{overrideReturnAddressId}'.replace('{format}', 'json')
        path_params = {}
        if 'override_return_address_id' in params:
            path_params['overrideReturnAddressId'] = params['override_return_address_id']
    ...
    def get_override_return_address_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/overrideReturnAddress/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_override_return_address_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_override_return_address_custom_fields(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_override_return_address_custom_fields`")

        resource_path = '/v2.0/overrideReturnAddress/customFields'.replace('{format}', 'json')
        path_params = {}
