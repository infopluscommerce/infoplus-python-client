...
class WarehouseDocumentTypeApi(object):
    ...
    def get_duplicate_warehouse_document_type_by_id(self, warehouse_document_type_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_duplicate_warehouse_document_type_by_id(warehouse_document_type_id, callback=callback_function)
    ...
    def get_warehouse_document_type_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_warehouse_document_type_by_filter(callback=callback_function)
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[WarehouseDocumentType]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_warehouse_document_type_by_id(self, warehouse_document_type_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_warehouse_document_type_by_id(warehouse_document_type_id, callback=callback_function)
