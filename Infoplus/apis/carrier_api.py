...
class CarrierApi(object):
    ...
    def get_carrier_by_id(self, carrier_id, **kwargs):
        """
        Get a carrier by id
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_carrier_by_id(carrier_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_carrier_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/v1.0/carrier/{carrierId}'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            response_type='Carrier',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_carrier_by_search_text(self, **kwargs):
        """
        Search carriers
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_carrier_by_search_text(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_carrier_by_search_text" % key
                )
            params[key] = val
        del params['kwargs']


        resource_path = '/v1.0/carrier/search'.replace('{format}', 'json')
        path_params = {}
