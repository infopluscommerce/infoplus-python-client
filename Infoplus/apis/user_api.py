...
class UserApi(object):
    ...
    def get_user_by_id(self, user_id, **kwargs):
        ...
        resource_path = '/v1.0/user/{userId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_user_by_search_text(self, **kwargs):
        """
        Search users
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_user_by_search_text(callback=callback_function)
        ...
        resource_path = '/v1.0/user/search'.replace('{format}', 'json')
        path_params = {}
