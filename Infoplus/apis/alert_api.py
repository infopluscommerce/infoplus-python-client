...
class AlertApi(object):
    ...
    def get_alert_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/alert/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_alert_by_id(self, alert_id, **kwargs):
        ...
        resource_path = '/v2.0/alert/{alertId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_alert_by_id(self, alert_id, **kwargs):
        ...
        resource_path = '/v2.0/alert/duplicate/{alertId}'.replace('{format}', 'json')
        path_params = {}
        if 'alert_id' in params:
            path_params['alertId'] = params['alert_id']
    ...
    def update_alert_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/alert/customFields'.replace('{format}', 'json')
        path_params = {}
