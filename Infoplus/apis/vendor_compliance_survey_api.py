...
class VendorComplianceSurveyApi(object):
    ...
    def get_duplicate_vendor_compliance_survey_by_id(self, vendor_compliance_survey_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_duplicate_vendor_compliance_survey_by_id(vendor_compliance_survey_id, callback=callback_function)
    ...
    def update_vendor_compliance_survey_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_vendor_compliance_survey_custom_fields(body, callback=callback_function)
