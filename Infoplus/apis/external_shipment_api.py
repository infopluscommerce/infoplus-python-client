...
class ExternalShipmentApi(object):
    ...
    def add_external_shipment(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_external_shipment(body, callback=callback_function)
        ...
        resource_path = '/v2.0/externalShipment'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_external_shipment(self, external_shipment_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_external_shipment(external_shipment_id, callback=callback_function)
        ...
        resource_path = '/v2.0/externalShipment/{externalShipmentId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_duplicate_external_shipment_by_id(self, external_shipment_id, **kwargs):
        ...
        resource_path = '/v2.0/externalShipment/duplicate/{externalShipmentId}'.replace('{format}', 'json')
        path_params = {}
        if 'external_shipment_id' in params:
            path_params['externalShipmentId'] = params['external_shipment_id']
    ...
    def get_external_shipment_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_external_shipment_by_filter(callback=callback_function)
        ...
        resource_path = '/v2.0/externalShipment/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[ExternalShipment]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_external_shipment_by_id(self, external_shipment_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_external_shipment_by_id(external_shipment_id, callback=callback_function)
    ...
    def update_external_shipment(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_external_shipment(body, callback=callback_function)
    ...
    def update_external_shipment_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/externalShipment/customFields'.replace('{format}', 'json')
        path_params = {}
