...
class JobTimeApi(object):
    ...
    def add_job_time(self, body, **kwargs):
        """
        Create a jobTime
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_job_time(body, callback=callback_function)
    ...
    def delete_job_time(self, job_time_id, **kwargs):
        """
        Delete a jobTime
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_job_time(job_time_id, callback=callback_function)
    ...
    def get_duplicate_job_time_by_id(self, job_time_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_duplicate_job_time_by_id(job_time_id, callback=callback_function)
    ...
    def get_job_time_by_filter(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_job_time_by_filter(callback=callback_function)
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='list[JobTime]',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_job_time_by_id(self, job_time_id, **kwargs):
        """
        Get a jobTime by id
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_job_time_by_id(job_time_id, callback=callback_function)
    ...
    def update_job_time(self, body, **kwargs):
        """
        Update a jobTime
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_job_time(body, callback=callback_function)
    ...
    def update_job_time_custom_fields(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_job_time_custom_fields(body, callback=callback_function)
