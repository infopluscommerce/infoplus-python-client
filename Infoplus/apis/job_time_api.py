...
class JobTimeApi(object):
    ...
    def add_job_time(self, body, **kwargs):
        ...
        resource_path = '/v1.0/jobTime'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_job_time(self, job_time_id, **kwargs):
        ...
        resource_path = '/v1.0/jobTime/{jobTimeId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_job_time_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/jobTime/search'.replace('{format}', 'json')
        path_params = {}
