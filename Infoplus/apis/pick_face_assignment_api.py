...
class PickFaceAssignmentApi(object):
    ...
    def add_pick_face_assignment(self, body, **kwargs):
        ...
        resource_path = '/v1.0/pickFaceAssignment'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_pick_face_assignment(self, pick_face_assignment_id, **kwargs):
        ...
        resource_path = '/v1.0/pickFaceAssignment/{pickFaceAssignmentId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_pick_face_assignment_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/pickFaceAssignment/search'.replace('{format}', 'json')
        path_params = {}
