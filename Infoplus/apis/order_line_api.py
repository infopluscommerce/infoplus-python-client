...
class OrderLineApi(object):
    ...
    def get_duplicate_order_line_by_id(self, order_line_id, **kwargs):
        ...
        resource_path = '/v2.0/orderLine/duplicate/{orderLineId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_order_line_by_filter(self, **kwargs):
        ...
        resource_path = '/v2.0/orderLine/search'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_order_line_by_id(self, order_line_id, **kwargs):
        ...
        resource_path = '/v2.0/orderLine/{orderLineId}'.replace('{format}', 'json')
        path_params = {}
        if 'order_line_id' in params:
            path_params['orderLineId'] = params['order_line_id']
    ...
    def update_order_line_custom_fields(self, body, **kwargs):
        ...
        resource_path = '/v2.0/orderLine/customFields'.replace('{format}', 'json')
        path_params = {}
