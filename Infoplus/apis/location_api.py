...
class LocationApi(object):
    ...
    def add_location(self, body, **kwargs):
        ...
        resource_path = '/v1.0/location'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_location(self, location_id, **kwargs):
        ...
        resource_path = '/v1.0/location/{locationId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_location_by_filter(self, **kwargs):
        ...
        resource_path = '/v1.0/location/search'.replace('{format}', 'json')
        path_params = {}
