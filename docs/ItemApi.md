...
[**add_item_file_by_url**](ItemApi.md#add_item_file_by_url) | **POST** /beta/item/{itemId}/file | Attach a file to an item by URL.
...
[**delete_item_file**](ItemApi.md#delete_item_file) | **DELETE** /beta/item/{itemId}/file/{fileId} | Delete a file for an item.
...
[**get_item_files**](ItemApi.md#get_item_files) | **GET** /beta/item/{itemId}/file | Get the files for an item.
