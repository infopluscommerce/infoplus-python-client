...
[**execute_external_shipment**](ExternalShipmentApi.md#execute_external_shipment) | **POST** /beta/externalShipment/executeExternalShipment | Execute externalShipment
...
# create an instance of the API class
api_instance = Infoplus.ExternalShipmentApi(Infoplus.ApiClient(configuration))
body = Infoplus.ExecuteExternalShipmentInputAPIModel() # ExecuteExternalShipmentInputAPIModel | ExternalShipment to be executed.
