...
------------- | ------------- | -------------
[**add_load_audit**](LoadApi.md#add_load_audit) | **PUT** /beta/load/{loadId}/audit/{loadAudit} | Add new audit for a load
[**add_load_file**](LoadApi.md#add_load_file) | **POST** /beta/load/{loadId}/file/{fileName} | Attach a file to a load
[**add_load_file_by_url**](LoadApi.md#add_load_file_by_url) | **POST** /beta/load/{loadId}/file | Attach a file to a load by URL.
[**add_load_tag**](LoadApi.md#add_load_tag) | **PUT** /beta/load/{loadId}/tag/{loadTag} | Add new tags for a load.
[**delete_load_file**](LoadApi.md#delete_load_file) | **DELETE** /beta/load/{loadId}/file/{fileId} | Delete a file for a load.
[**delete_load_tag**](LoadApi.md#delete_load_tag) | **DELETE** /beta/load/{loadId}/tag/{loadTag} | Delete a tag for a load.
[**get_duplicate_load_by_id**](LoadApi.md#get_duplicate_load_by_id) | **GET** /beta/load/duplicate/{loadId} | Get a duplicated a load by id
[**get_load_by_filter**](LoadApi.md#get_load_by_filter) | **GET** /beta/load/search | Search loads by filter
[**get_load_by_id**](LoadApi.md#get_load_by_id) | **GET** /beta/load/{loadId} | Get a load by id
[**get_load_files**](LoadApi.md#get_load_files) | **GET** /beta/load/{loadId}/file | Get the files for a load.
[**get_load_tags**](LoadApi.md#get_load_tags) | **GET** /beta/load/{loadId}/tag | Get the tags for a load.
[**update_load_custom_fields**](LoadApi.md#update_load_custom_fields) | **PUT** /beta/load/customFields | Update a load custom fields
