...
------------- | ------------- | -------------
[**add_parcel_account**](ParcelAccountApi.md#add_parcel_account) | **POST** /beta/parcelAccount | Create a parcelAccount
...
[**update_parcel_account**](ParcelAccountApi.md#update_parcel_account) | **PUT** /beta/parcelAccount | Update a parcelAccount
