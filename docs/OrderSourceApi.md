...
[**add_order_source_file_by_url**](OrderSourceApi.md#add_order_source_file_by_url) | **POST** /beta/orderSource/{orderSourceId}/file | Attach a file to an orderSource by URL.
...
[**delete_order_source_file**](OrderSourceApi.md#delete_order_source_file) | **DELETE** /beta/orderSource/{orderSourceId}/file/{fileId} | Delete a file for an orderSource.
...
[**get_order_source_files**](OrderSourceApi.md#get_order_source_files) | **GET** /beta/orderSource/{orderSourceId}/file | Get the files for an orderSource.
